...
namespace IwAutoUpdater.BLL.CommandPlanner.Contracts
{
    public interface IConfigurationConverter
    {
        ...
        IEnumerable<INotificationReceiver> ConvertMessageReceivers(IEnumerable<MessageReceiver> receivers, AddressUsernamePassword mailSettings, string fromEMailAddress);
    }
}
