...
namespace IngSoft.SmbClient
{
    ...
    /// Impersonate smb
    /// </summary>
    /// <see cref="http://lookfwd.doitforme.gr/blog/media/PinvokeWindowsNetworking.cs"/>
    public class PinvokeWindowsNetworking
    {
        ...
        private static ErrorClass[] ERROR_LIST = new ErrorClass[] {
            ...
            new ErrorClass(1219, "Error: You cannot login to the same server twice from the same client at the same time") // MaG, 2013-07-01: empirisch gefunden und mit Google Suche verfeinert
        };
